...
static const char *Preloaded_bitmap_list[] = {
	...
	NEWUI_BTNLIT_FILE,
	NEWUI_LCHKBTN_FILE,
	NEWUI_LCHKBTNLIT_FILE,
	NEWUI_CHKBTN_FILE,
	NEWUI_CHKBTNLIT_FILE,
	NEWUI_TINYBTN_FILE,
	NEWUI_TINYBTNLIT_FILE,
	...
	NEWUI_WIN_NW_FILE,
	NEWUI_WIN_C_FILE,
	NEWUI_WIN_TITLE_L_FILE,
	NEWUI_WIN_TITLE_C_FILE,
	NEWUI_WIN_TITLE_R_FILE,
};
...
void newuiMenu::SetCurrentOption(short id)
{
	m_newoptionid = id;
}
...
UIGadget *newuiSheet::GetGadget(short id)
{
	...
	for (i = 0; i < m_ngadgets; i++)
	{
		...
		if (desc->obj.gadget && id == (short)desc->obj.gadget->GetID()) {
			...
			case GADGET_STATIC_BMP: return desc->obj.gadget;
			case GADGET_BUTTON: return desc->obj.button;
			case GADGET_HOTSPOT: return desc->obj.hot;
			case GADGET_CHECKBOX: return desc->obj.chbox;
			case GADGET_RADIO: return desc->obj.radio;
			case GADGET_LBUTTON: return desc->obj.button;
			...
			case GADGET_COMBOBOX: return desc->obj.cb;
			case GADGET_CHANGEABLE_TXT: return desc->obj.text;
...
void newuiArrowButton::Show(bool show)
{
	m_hidden = !show;
}
...
// set callbacks
void newuiListBox::SetSelectChangeCallback(void (*fn)(int))
{
	selectchange_fn = fn;
}
...
// set callbacks
void newuiComboBox::SetSelectChangeCallback(void (*fn)(int))
{
	selectchange_fn = fn;
}
...
//	adjust w and height acoordingly with bitmap background width and height.
	...
	if (bk_width < 4) bk_width = 4;
	if (bk_height < 4) bk_height = 4;
