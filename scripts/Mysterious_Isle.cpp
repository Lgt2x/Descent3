...
$$END
*/
int qCustomGetID(char *name) { return Obj_FindID(name); }
...
char *Room_names[NUM_ROOM_NAMES] = {"Valcanic Shaft", "Death Reach 2", "Death's Viel", "Death's Reach"};
...
char *Sound_names[NUM_SOUND_NAMES] = {"Drop weapon", "AmbVolcanoErupt"};
...
char *Path_names[NUM_PATH_NAMES] = {"BallonCrazyPath"};
...
char *Message_names[NUM_MESSAGE_NAMES] = {"HackBot", "Message1"};
...
short CustomObjectScript_481D::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_CREATED: {
...
short CustomObjectScript_101E::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_CREATED: {
    tOSIRISEVTCREATED *event_data = &data->evt_created;
...
short CustomObjectScript_1021::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_CREATED: {
    tOSIRISEVTCREATED *event_data = &data->evt_created;
...
short CustomObjectScript_1020::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_CREATED: {
    tOSIRISEVTCREATED *event_data = &data->evt_created;
...
short CustomObjectScript_1823::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_CREATED: {
    tOSIRISEVTCREATED *event_data = &data->evt_created;
...
short CustomObjectScript_101F::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_CREATED: {
    tOSIRISEVTCREATED *event_data = &data->evt_created;
...
short CustomObjectScript_2828::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_COLLIDE: {
